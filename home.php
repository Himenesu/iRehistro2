            ...
            <br> <br><h1>Welcome <?php echo $fetch_info['name'] ?></h1>
                    ...
                    <div class="wrapper">
                        ...
                        <div class="inputfield">
                              <input type="hidden" name="usertype" class="input" value="user">
                           </div> 
                           <div class="inputfield">
                              <label>First Name:</label>
                              <input type="text" name="firstname" class="input" pattern="[a-zA-Z]{1,}" title="Kindly input letters only" placeholder="Iyong unang pangalan" required>
                           </div> 
                           <div class="inputfield">
                              <label>Middle Name:</label>
                              <input type="text" name="midname" class="input" pattern="[a-zA-Z]{1,}" title="Kindly input letters only" placeholder="Iyong gitnang pangalan" required>
                           </div>   
                            <div class="inputfield">
                              <label>Last Name:</label>
                              <input type="text" name="lastname" class="input" pattern="[a-zA-Z]{1,}" title="Kindly input letters only" placeholder="Iyong apelyido" required>
                           </div>  
                           <div class="inputfield">
                              <label>Birthdate:</label>
                              <input type="date" name="birthdate" min='1899-01-01' max='2003-04-30' class="input" required>
                           </div>   
                            <div class="inputfield">
                              <label>Birthplace:</label>
                              <input type="text" name="birthplace" pattern="[a-zA-Z]{1,}" title="Kindly input letters only" placeholder="Lugar kung saan ka ipinanganak" class="input" required>
                            </div>  
                            <div class="inputfield">
                              <label>Gender:</label>
                          ...
                          <div class="inputfield">
                              ...
                              <input type="text" name="contact" pattern="[0-9]{11}" title="Kindly input 11 numbers only please" placeholder="ilagay ang iyong telepono" class="input" required>
                           </div> 
                          <div class="inputfield">
                              <label>Postal Code:</label>
                              <input type="text" name="postal" pattern="[0-9]{4}" title="Kindly input 4 numbers only please" class="input" placeholder="Postal code ng iyong lugar" required>
                           </div> 
                        </div>
                    </div>
                    ...
                    <div class="inputfield">
                        ...
                        <div class="custom_select" >
                            <select name="acquisition" required>
                            <option value="">- Select -</option>
                    ...
                    <span class="help-block">(Tirahan)</span>
                        ...
                        <div class="form">
                            <div class="inputfield">
                                ...
                                <option value="NCR - 1">NCR - 1st DISTRICT (Manila)</option>
                                <option value="NCR - 2">NCR - 2ND DISTRICT (Mandaluyong, Marikina, Pasig, QC, San Juan)</option>
                                <option value="NCR - 3">NCR - 3RD DISTRICT (Caloocan, Malabon, Navotas, Valenzuela)</option>
                                <option value="NCR - 4">NCR - 4TH DISTRICT (Las Piñas, Makati, Muntinlupa, Parañaque, Pasay, Pateros, Taguig)</option>
                            ...
                            <div class="inputfield">
                              ...
                              <input type="text" name="brgy" class="input" placeholder="Barangay na iyong tinitirahan" required>
                            </div>
                            <div class="inputfield">
                                <label>Address</label>
                                <textarea class="textarea" name="address" placeholder="Ilagay ang iyong address" required></textarea>
                             </div> 
                            <div class="inputfield">
                              <label>No. of Years and Months in the City / Municipality:</label>
                              <textarea class="textarea" name="city_years_months_number" class="input" placeholder="Ilagay kung ilang taon at ilang buwan ka na nakatira sa lungsod" maxlength="15" required></textarea>
                            </div>
                            <div class="inputfield">
                              <label>No. of Years in the Philippines</label>
                              <textarea class="textarea" name="country_years_number" placeholder="Ilagay kung ilang taon ka na nakatira sa Pilipinas" maxlength="3" required></textarea>
                            </div>
                        </div>
                    </div>
