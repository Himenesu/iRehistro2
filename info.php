...
<div class="container">
    <div class="forms-container">   
        <div class="signin-signup">  
            <br> <br><h1>Welcome <?php echo $fetch_info['name'] ?></h1>

                        <form action="typage.php" method="POST" class="form-horizontal">
                    ...
                    <div class="wrapper">
                        ...
                        <h3>Note: Make sure that all of the information are correct. Once you submit the form you will not be able to edit it, this is for security purposes. You may contact us on our customer service email: iRehistro.au@gmail.com, if you have any problems or questions. </h3><br>
                        <div class="form">
                           <div class="inputfield">
                              <label>First Name:</label>
                              <input type="text" name="firstname" class="input" pattern="[a-zA-Z]{1,}" title="Kindly input letters only" placeholder="Iyong gitnang pangalan" value="<?php echo $fetch_info['firstname']; ?>" required>
                           </div> 
                           <div class="inputfield">
                              <label>Middle Name:</label>
                              <input type="text" name="midname" class="input" pattern="[a-zA-Z]{1,}" title="Kindly input letters only" placeholder="Iyong gitnang pangalan" value="<?php echo $fetch_info['midname']; ?>" required>
                           </div>   
                            <div class="inputfield">
                              <label>Last Name:</label>
                              <input type="text" name="lastname" class="input" pattern="[a-zA-Z]{1,}" title="Kindly input letters only" placeholder="Iyong apelyido" value="<?php echo $fetch_info['lastname']; ?>" required>
                           </div>  
                           <div class="inputfield">
                              <label>Birthdate:</label>
                              <input type="date" name="birthdate" min='1899-01-01' max='2003-04-30' class="input" value="<?php echo $fetch_info['birthdate']; ?>" required>
                           </div>   
                            <div class="inputfield">
                              <label>Birthplace:</label>
                              <input type="text" name="birthplace" pattern="[a-zA-Z]{1,}" title="Kindly input letters only" placeholder="Lugar kung saan ka ipinanganak" class="input" value="<?php echo $fetch_info['birthplace']; ?>" required>
                            </div>  
                            <div class="inputfield">
                              <label>Gender:</label>
                              <div class="custom_select">
                                <select name="gender" value="<?php echo $fetch_info['gender']; ?>" required>
                          ...
                          <div class="inputfield">
                              ...
                              <input type="text" name="contact" pattern="[0-9]{11}" title="Kindly input 11 numbers only please" placeholder="ilagay ang iyong telepono" class="input" value="<?php echo $fetch_info['contact']; ?>" required>
                           </div> 
                          <div class="inputfield">
                              <label>Postal Code:</label>
                              <input type="text" name="postal" pattern="[0-9]{4}" title="Kindly input 4 numbers only please" class="input" placeholder="Postal code ng iyong lugar" value="<?php echo $fetch_info['postal']; ?>" required>
                           </div> 
                        </div>
                    </div>
                    ...
                    <div class="inputfield">
                        ...
                        <div class="custom_select">
                            <select name="citizen" value="<?php echo $fetch_info['citizen']; ?>" required>
                    ...
                    <div class="inputfield">
                        ...
                        <div class="custom_select" >
                            <select name="acquisition" value="<?php echo $fetch_info['acquisition']; ?>" required>
                            <option value="">- Select -</option>
                    ...
                    <span class="help-block">(Tirahan)</span>
                        ...
                        <div class="form">
                            <div class="inputfield">
                                <label>Province/Rehiyon:</label>
                                <div class="custom_select">
                                <select name="province" value="<?php echo $fetch_info['province']; ?>" required>
                                <option value="">- Select -</option>
                            ...
                            <div class="inputfield">
                              ...
                              <input type="text" name="city" class="input" placeholder="Iyong lungsod na tinitirahan" value="<?php echo $fetch_info['city']; ?>" required>
                            </div>
                            <div class="inputfield">
                              <label>Barangay:</label>
                              <input type="text" name="brgy" class="input" placeholder="Barangay na iyong tinitirahan" value="<?php echo $fetch_info['brgy']; ?>" required>
                            </div>
                            <div class="inputfield">
                                <label>Address</label>
                                <textarea class="textarea" name="address" placeholder="Ilagay ang iyong address" value="<?php echo $fetch_info['address']; ?>" required></textarea>
                             </div> 
                            <div class="inputfield">
                              <label>No. of Years and Months in the City / Municipality:</label>
                              <textarea class="textarea" name="city_years_months_number" class="input" placeholder="Ilagay kung ilang taon at ilang buwan ka na nakatira sa lungsod" maxlength="15" value="<?php echo $fetch_info['city_years_months_number']; ?>" required></textarea>
                            </div>
                            <div class="inputfield">
                              <label>No. of Years in the Philippines</label>
                              <textarea class="textarea" name="country_years_number" placeholder="Ilagay kung ilang taon ka na nakatira sa Pilipinas" maxlength="3" value="<?php echo $fetch_info['country_years_number']; ?>" required></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wrapper">
                        <div class="form">
                            ...
                            <div class="inputfield"> 
                                <input class="btn" type="submit" name="editbtn2" value="Edit">
                            </div>  
                        </div>
                    </div>
                </form>
