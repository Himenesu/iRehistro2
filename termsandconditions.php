    ...
    <div class="wrapper">
        <div class="form">
            <div class="inputfield">
                ...
                <h2>Welcome to iRegister!</h2><br>
                <p>These terms and conditions outline the rules and regulations for the use of iRegister for Students of Arellano University Plaridel Campus's Website, located at http://localhost/ResearchProject/secondpage.php?pass=daadsa&amp;btn2=Login.</p><br>
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use iRegister if you do not agree to take all of the terms and conditions stated on this page.</p><br>
                ...
                <h1><strong>Cookies</strong></h1><br>
                <p>We employ the use of cookies. By accessing iRegister, you agreed to use cookies in agreement with the iRegister for Students of Arellano University Plaridel Campus's Privacy Policy. </p><br>
                ...
                <h1><strong>License</strong></h1><br>
                <p>Unless otherwise stated, iRegister for Students of Arellano University Plaridel Campus and/or its licensors own the intellectual property rights for all material on iRegister. All intellectual property rights are reserved. You may access this from iRegister for your own personal use subjected to restrictions set in these terms and conditions.</p><br>
                <p>You must not:</p><br>
                <ul>
                    <li>Republish material from iRegister</li><br>
                    <li>Sell, rent or sub-license material from iRegister</li><br>
                    <li>Reproduce, duplicate or copy material from iRegister</li><br>
                    <li>Redistribute content from iRegister</li><br>
                </ul>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. iRegister for Students of Arellano University Plaridel Campus does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of iRegister for Students of Arellano University Plaridel Campus, its agents, and/or affiliates. Comments reflect the views and opinions of the person who posts their views and opinions. To the extent permitted by applicable laws, iRegister for Students of Arellano University Plaridel Campus shall not be liable for the Comments or any liability, damages, or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p><br>
                <p>iRegister for Students of Arellano University Plaridel Campus reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive, or causes breach of these Terms and Conditions.</p><br>
                ...
                <p>You hereby grant iRegister for Students of Arellano University Plaridel Campus a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats, or media.</p><br>
                <h1><strong>Hyperlinking to our Content</strong></h1><br>
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of iRegister for Students of Arellano University Plaridel Campus, and (d) the link is in the context of general resource information.</p><br>
                ...
                <p>No use of iRegister for Students of Arellano University Plaridel Campus's logo or other artwork will be allowed for linking absent a trademark license agreement.</p><br>
                <h1><strong>iFrames</strong></h1><br>
                ...
                <h1><strong>Removal of links from our website</strong></h1><br>
                <p>If you find any link on our Website that is offensive for any reason, you are free to contact and inform us at any moment. We will consider requests to remove links but we are not obligated to or so or to respond to you directly.</p><br>
                ...
                <h1><strong>Disclaimer</strong></h1><br>
